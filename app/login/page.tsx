...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[url('/assets/images/login_bg_2x.png')] bg-no-repeat bg-cover">
      <div className="">
        <h2 className="text-[32px] leading-[28px] text-white text-center font-extrabold">
          Welcome to HiveMind
        </h2>
        <h4 className="text-center text-[16px] leading-[24px] text-white font-medium">
          Shaping Tomorrow Together
        </h4>
        <div className="bg-white rounded-lg w-[400px] mx-auto py-[32px] mt-[32px]">
          <div className="flex items-center justify-center gap-2">
            <img src="/assets/images/logo.svg" alt="logo" />
            <p className=" text-[26px] leading-[19px] text-black font-semibold">
          ...
          <form className="px-6 pt-[30px] flex flex-col items-center">
            <input
              ...
              className="p-1.5 rounded-lg text-black border border-blue-600 w-full"
            ></input>
            <p>{userMessage}</p>
            <button
              type="button"
              onClick={handleLoginButtonClicked}
              className="mt-5 border border-blue-600 rounded-xl font-semibold px-3 py-1.5 text-black hover:bg-blue-500 hover:text-white"
            >
